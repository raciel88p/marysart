export const servicesData = {
  'restauracion-sacra': {
    ...
    processSteps: [
      { title: '1. Diagnóstico e Inspección Técnica', desc: 'Evaluamos el estado de conservación, grietas, faltantes de masa, capas de pintura posteriores y tipo de soporte (yeso, resina o madera).' },
      { title: '2. Limpieza y Consolidación de Estructura', desc: 'Removemos suciedad acumulada y estabilizamos la estructura para evitar desprendimientos futuros.' },
      { title: '3. Resane y Reconstrucción Escultórica', desc: 'Modelamos artesanalmente los dedos, rostros o atributos faltantes utilizando pastas y resinas de conservación.' },
      { title: '4. Reintegración Cromática y Policromía', desc: 'Aplicamos la paleta de color correspondiente con pigmentos finos y técnicas tradicionales de pincel en frío y sombras.' },
      { title: '5. Aplicación de Pan de Oro y Acabados Finos', desc: 'Renovamos aureolas, mantos y bordes con dorados metálicos, hojilla de oro y pátinas envejecidas según el estilo de la obra.' },
      { title: '6. Barniz Protector de Larga Duración', desc: 'Sellamos la pieza con capas protectoras mate o satinadas para protegerla contra el polvo y la humedad.' }
    ],
    materialsHandled: [
    ...
    faqs: [
      { q: '¿Cómo obtengo un presupuesto de restauración?', a: 'Envíanos fotografías claras por WhatsApp mostrando la figura completa y los detalles con grietas o faltantes, junto con la altura en centímetros. Te brindaremos un estimado inicial.' },
      { q: '¿Dónde se reciben las piezas?', a: 'Contamos con puntos de recepción en Turrialba y San Carlos, Costa Rica, previa coordinación.' },
      { q: '¿Cuánto tiempo tarda la restauración?', a: 'El tiempo promedio varía entre 1 y 3 semanas según la complejidad y el secado de las capas de pintura y resane.' }
    ]
  },
  'arte-resina-personalizado': {
    ...
    processSteps: [
      { title: '1. Selección del Diseño y Figura', desc: 'Elige la pieza de nuestro catálogo digital o solicita un modelo especial de tu preferencia.' },
      { title: '2. Definición de Paleta de Colores y Estilo', desc: 'Coordinamos los tonos, metálicos (dorado, bronce, cobre, plata) y efectos (pátina envejecida, mate o brillo pulido).' },
      { title: '3. Preparación de la Pieza en Resina', desc: 'Inspeccionamos, pulimos y sellamos la figura para asegurar una adherencia perfecta de los pigmentos.' },
      { title: '4. Pintura Artística a Mano', desc: 'Nuestra instructora Maria aplica cuidadosamente pinceladas, degradados y luces para dar vida y dimensión a la pieza.' },
      { title: '5. Sellado Profesional y Acabado', desc: 'Protegemos la obra con barnices especiales de alta resistencia que aseguran la durabilidad del color.' },
      { title: '6. Empaque Especial y Entrega', desc: 'Preparamos la pieza con empaque de regalo y protección especial lista para lucir o entregar.' }
    ],
    materialsHandled: [
    ...
    faqs: [
      { q: '¿Puedo enviar fotos de mi espacio para que me sugieran colores?', a: '¡Por supuesto! Nos encanta asesorarte para que la pieza combine armónicamente con tus paredes, muebles y cortinas.' },
      { q: '¿Hacen envíos a todo Costa Rica?', a: 'Sí, coordinamos entregas en Turrialba y San Carlos, así como envíos seguros por encomienda o Correos de Costa Rica.' },
      { q: '¿Tienen pedidos para eventos o recuerdos corporativos?', a: 'Ofrecemos precios especiales al por mayor para bodas, bautizos, recuerdos empresariales y regalos navideños.' }
    ]
  },
  ...
  'restauracion-imagenes-catolicas': {
    ...
    subtitle: 'Servicio completo para imágenes del santoral católico, pesebres y devociones de hogar',
